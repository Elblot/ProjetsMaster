...
#pragma omp task depend(in : table[1][y-1]) depend(out : table[x][y]) firstprivate(x,y)	    
...
#pragma omp task depend(in : table[x-1][1]) depend(out : table[x][y]) firstprivate(x,y)
...
#pragma omp task depend(in : table[x-1][y], table[x][y-1]) depend(out : table[x][y]) firstprivate(x,y)
